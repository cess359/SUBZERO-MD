...
module.exports = {
    ...
    OWNER_NAME: process.env.OWNER_NAME || "Kele",           // Owner's name
    DEV: process.env.DEV || "kelo",                     // Developer's contact number
    ...
    DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴍʀ Kelo*",  // Bot description
